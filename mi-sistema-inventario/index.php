                    ...
                    <tbody class="divide-y divide-slate-800">
                        ...
                        <tr class="hover:bg-slate-800/30 transition-colors">
                            ...
                            <td class="px-6 py-5 text-center">
                                <span class="bg-slate-800 px-3 py-1 rounded-lg text-[10px] border border-slate-700"><?= $item['nombre_area'] ?></span>
                            </td>
                            <td class="px-6 py-5 text-center font-mono text-indigo-400">$<?= number_format($item['precio'], 2) ?></td>
